# Runbook — sdkwork-documents deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-documents-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-documents/bundle`, loads the image, starts
